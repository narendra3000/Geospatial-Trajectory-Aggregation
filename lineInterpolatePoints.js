...
function interpolateLineRange( ctrlPoints, number, offsetDist, minGap )
{
	...
	for( pt = 0; pt < number - 2; pt++ )
	{
		...
		interpPoints.push( offsetPoint(currPoint, ctrlPtsDeltaX, ctrlPtsDeltaY, ptOffsetRatios[ prevCtrlPtInd ]));
	...
	myPoints[cnt]=interpPoints;
	cnt++;
	return interpPoints;
}

for(var i=0; i<FullData.length; i++)
	module.exports = interpolateLineRange(FullData[i],500,0,0);
